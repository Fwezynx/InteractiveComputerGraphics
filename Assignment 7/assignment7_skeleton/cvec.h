...
template<typename T, int n>
inline Cvec<T, n> interpolateCatmullRom(const Cvec <T, n>& v0, const Cvec <T, n>& v1, const Cvec <T, n>& v2, const Cvec <T, n>& v3, const double alpha) {
  Cvec<T, n> d = v1 + (v2 - v0) * (1.0/6.0);
  Cvec<T, n> e = v2 - (v3 - v1) * (1.0/6.0);

  Cvec<T, n> f = lerp(v1, d, alpha);
  Cvec<T, n> g = lerp(d, e, alpha);
  Cvec<T, n> h = lerp(e, v2, alpha);
  Cvec<T, n> m = lerp(f, g, alpha);
  Cvec<T, n> o = lerp(g, h, alpha);
  return  lerp(m, o, alpha);
